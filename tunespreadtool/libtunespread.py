...
def get_inputs(filenames, params, f_interactive, f_verbose):
    ...
    inputs = { "machine": None, "mass": None, "n_part": None, 
                    "lshape": None, "emit_geom_x": None, 
                    "emit_geom_y": None, "gamma": None, 
                    "sig_z": None, "deltaE": None }
